...
import { NotificiationGroup } from "./NotificiationGroup";
import { render, screen } from "@testing-library/react";

describe("NotificiationGroup", () => {
  it("renders without errors", () => {
    render(<NotificiationGroup />);
    // Assert that the component renders without throwing any errors
  });

  it("renders with children", () => {
    render(<NotificiationGroup>Some children</NotificiationGroup>);
  ...
  it("matches snapshot", () => {
    const { container } = render(<NotificiationGroup />);
